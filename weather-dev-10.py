...
class IrcBot:
    ...
    async def fetch_and_send_weather(self, channel, location):
        ...
        if cache_key in self.weather_cache:
            ...
            try:
                ...
                error_msg = "Error fetching weather information."
                await self.send_message(channel, error_msg)
                return
        ...
        try:
            ...
            error_msg = "Error processing weather information."
            await self.send_message(channel, error_msg)
    ...
    async def send_message(self, channel, message):
        """Send a message to the IRC channel, ensuring it doesn't exceed the max length."""
